  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <CardDataStats title="Active Jobs" total={stats?.activeJobsCount?.toString() || "0"} rate="in your workshop" levelUp>
          <svg className="fill-primary dark:fill-white" width="22" height="22" viewBox="0 0 22 22" fill="none">
            <path d="M16.2374 2.8125H13.1062V2.25C13.1062 1.6875 12.6562 1.2375 12.0937 1.2375H5.9062C5.3437 1.2375 4.8937 1.6875 4.8937 2.25V2.8125H1.76245C1.19995 2.8125 0.749951 3.2625 0.749951 3.825V5.2875C0.749951 6.4125 1.53745 7.3125 2.66245 7.425L3.0187 15.8625C3.07495 16.425 3.5812 16.875 4.1437 16.875H13.8562C14.4187 16.875 14.925 16.425 14.9812 15.8625L15.3374 7.425C16.4624 7.3125 17.2499 6.4125 17.2499 5.2875V3.825C17.2499 3.2625 16.7999 2.8125 16.2374 2.8125Z" fill=""/>
          </svg>
        </CardDataStats>
      ...
      <div className="mt-8 rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <a href="/jobs" className="flex items-center gap-4 rounded-lg border border-stroke p-4 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4">
            ...
            <div>
              <h4 className="font-medium">New Job / Order</h4>
              <p className="text-sm text-gray-500">Start a new repair job</p>
            </div>
          </a>
      ...
      <div className="mt-8">
        <div className="rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <ol className="list-inside list-decimal space-y-2 text-gray-600 dark:text-gray-400">
            <li>Add customers to your directory</li>
            <li>Create jobs/orders for each customer (service, repair, etc.)</li>
            <li>Track job status from pending → in progress → completed → delivered</li>
            <li>Track leads for potential new business</li>
            <li>Export reports to CSV for your records</li>
          </ol>
        </div>
      </div>
    </>

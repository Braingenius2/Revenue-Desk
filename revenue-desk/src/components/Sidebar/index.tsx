...
{/* <!-- Menu Item Leads --> */}
              <li>
                ...
                >
                  <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    <path d="M9.0002 1.7719C5.02845 1.7719 1.77197 5.02835 1.77197 9.0001C1.77197 12.9718 5.02845 16.2283 9.0002 16.2283C12.9719 16.2283 16.2284 12.9718 16.2284 9.0001C16.2284 5.02835 12.9719 1.7719 9.0002 1.7719ZM9.0002 14.9533C6.3252 14.9533 4.05345 12.7096 4.05345 10.0346C4.05345 7.3596 6.3252 5.11585 9.0002 5.11585C11.6752 5.11585 13.9469 7.3596 13.9469 10.0346C13.9469 12.7096 11.6752 14.9533 9.0002 14.9533Z" fill=""/>
                    <path d="M9.0002 7.25623C7.66207 7.25623 6.6002 8.3181 6.6002 9.65623C6.6002 10.9944 7.66207 12.0562 9.0002 12.0562C10.3383 12.0562 11.4002 10.9944 11.4002 9.65623C11.4002 8.3181 10.3383 7.25623 9.0002 7.25623Z" fill=""/>
                  </svg>
                  Leads
                </Link>
              </li>
              ...
              <li>
                ...
                >
                  <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    <path d="M9.0002 1.7719C5.02845 1.7719 1.77197 5.02835 1.77197 9.0001C1.77197 12.9718 5.02845 16.2283 9.0002 16.2283C12.9719 16.2283 16.2284 12.9718 16.2284 9.0001C16.2284 5.02835 12.9719 1.7719 9.0002 1.7719ZM4.5002 9.4501C4.5002 8.1501 5.5502 7.1001 6.8502 7.1001C8.1502 7.1001 9.2002 8.1501 9.2002 9.4501C9.2002 10.7501 8.1502 11.8001 6.8502 11.8001C5.5502 11.8001 4.5002 10.7501 4.5002 9.4501Z" fill=""/>
                    <path d="M14.6252 14.6251H12.1502V12.1501C12.1502 10.1251 10.5002 8.4751 8.4752 8.4751C6.4502 8.4751 4.8002 10.1251 4.8002 12.1501V14.6251H2.3252C1.7252 14.6251 1.3502 15.0001 1.3502 15.6001C1.3502 16.2001 1.7252 16.5751 2.3252 16.5751H14.6252C15.2252 16.5751 15.6002 16.2001 15.6002 15.6001C15.6002 15.0001 15.2252 14.6251 14.6252 14.6251Z" fill=""/>
                  </svg>
                  Customers
                </Link>
              </li>
              ...
              <li>
                ...
                >
                  <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.2374 2.8125H13.1062V2.25C13.1062 1.6875 12.6562 1.2375 12.0937 1.2375H5.9062C5.3437 1.2375 4.8937 1.6875 4.8937 2.25V2.8125H1.76245C1.19995 2.8125 0.749951 3.2625 0.749951 3.825V5.2875C0.749951 6.4125 1.53745 7.3125 2.66245 7.425L3.0187 15.8625C3.07495 16.425 3.5812 16.875 4.1437 16.875H13.8562C14.4187 16.875 14.925 16.425 14.9812 15.8625L15.3374 7.425C16.4624 7.3125 17.2499 6.4125 17.2499 5.2875V3.825C17.2499 3.2625 16.7999 2.8125 16.2374 2.8125ZM6.0937 2.4375H11.9062V2.8125H6.0937V2.4375ZM12.6562 15.75H5.3437L5.01557 7.48125H12.9843L12.6562 15.75ZM15.9374 5.2875C15.9374 5.7375 15.5437 6.13125 15.0937 6.13125H2.9062C2.51245 6.13125 2.06245 5.79375 2.06245 5.2875V3.9375H4.8937H13.1062H15.9374V5.2875Z" fill=""/>
                    <path d="M6.37495 9.28125C5.9812 9.28125 5.6437 9.61875 5.6437 10.0125V13.2563C5.6437 13.65 5.9812 13.9875 6.37495 13.9875C6.7687 13.9875 7.1062 13.65 7.1062 13.2563V10.0125C7.1062 9.61875 6.7687 9.28125 6.37495 9.28125Z" fill=""/>
                    <path d="M8.99995 9.28125C8.6062 9.28125 8.2687 9.61875 8.2687 10.0125V13.2563C8.2687 13.65 8.6062 13.9875 8.99995 13.9875C9.3937 13.9875 9.7312 13.65 9.7312 13.2563V10.0125C9.7312 9.61875 9.3937 9.28125 8.99995 9.28125Z" fill=""/>
                    <path d="M11.6249 9.28125C11.2312 9.28125 10.8937 9.61875 10.8937 10.0125V13.2563C10.8937 13.65 11.2312 13.9875 11.6249 13.9875C12.0187 13.9875 12.3562 13.65 12.3562 13.2563V10.0125C12.3562 9.61875 12.0187 9.28125 11.6249 9.28125Z" fill=""/>
                  </svg>
                  Jobs
                </Link>
              </li>
